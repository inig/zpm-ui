<template>
  <button :class="classes"
    ...
    <Icon class="zpm-load-loop"
          type="ios-loading"
          v-if="loading"></Icon>
    <Icon :type="icon"
          :custom="customIcon"
          v-if="(icon || customIcon) && !loading"></Icon>
    <!--<span>-->
    <slot></slot>
    <!--</span>-->
    <component v-for="(v, k) in ripples"
               :key="k"
               v-if="ripple"
               :id="k"
               :rect="v.rect"
