  ...
  <div :class="classes"
    ...
    <transition name="transition-drop">
      <Drop v-show="visible"
            ...
            v-transfer-dom>
        <div>
          <Caspanel v-show="!filterable || (filterable && query === '')"
                    ref="caspanel"
          ...
          <div :class="[prefixCls + '-dropdown']"
            ...
            <ul :class="[selectPrefixCls + '-dropdown-list']">
              <li :class="[selectPrefixCls + '-item', {
                  ...
                  v-html="item.display"></li>
            </ul>
          </div>
          <ul v-show="filterable && query !== '' && !querySelections.length"
...
export default {
  ...
  props: {
    ...
    size: {
      ...
      default () {
        return !this.$zpm || this.$zpm.size === '' ? 'default' : this.$zpm.size;
      }
    },
    trigger: {
      validator (value) {
    ...
    transfer: {
      type: Boolean,
      default () {
        return !this.$zpm || this.$zpm.transfer === '' ? false : this.$zpm.transfer;
      }
    },
    name: {
      type: String
